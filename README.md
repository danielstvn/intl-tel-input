# library-original-ng-update

This is an updated and modified version of [Original Library](https://github.com/webcat12345/ngx-intl-tel-input?tab=readme-ov-file) to be compatible with Angular 18+.

## Changes made
- Updated dependencies for Angular 18

## Attribution
This project is a modification of [ngx-intl-tel-input] by [nicolasleb], under the MIT license.

## License
This project maintains the original MIT license. See LICENSE file for more details.
